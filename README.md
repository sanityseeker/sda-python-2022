...
- [15.09.2022](seminar_3_lists_regexp) -- Другие последовательности: bytes, list. Внутреннее устройство списка ("список" -- это массив ссылок). Операции со списками. Изменяемость списков. Range.
...
- Семинар 3: "Генерация пароля" и "Замена личных почт". Активно до 22 сентября.
- Семинар 4: "Палиндром". Активно до 23 сентября.
